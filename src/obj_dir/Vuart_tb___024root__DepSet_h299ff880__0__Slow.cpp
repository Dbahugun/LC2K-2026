...
#endif
            VL_FATAL_MT("uart_tb.sv", 6, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vuart_tb___024root___ctor_var_reset(Vuart_tb___024root* vlSelf) {
    ...
    vlSelf->uart_tb__DOT__dut__DOT__computerDisplay__DOT____Vlvbound_he25d61a8__0 = VL_RAND_RESET_I(8);
    VL_RAND_RESET_W(256, vlSelf->uart_tb__DOT__dut__DOT__computerDisplay__DOT____Vlvbound_h1d59670b__0);
