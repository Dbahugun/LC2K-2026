...
VL_ATTR_COLD void Vtop_tb___024root__trace_init_sub__TOP__0(Vtop_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+59,0,"W",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBit(c+60,0,"gw_gnd",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+61,0,"regDest_val",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+62,0,"S",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBit(c+55,0,"clk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+55,0,"clk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+63,0,"oce",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+63,0,"ce",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+57,0,"reset",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+63,0,"ocea",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+63,0,"cea",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+60,0,"oceb",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+60,0,"ceb",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+60,0,"wreb",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+64,0,"adb",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+65,0,"dinb",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->popPrefix();
...
VL_ATTR_COLD void Vtop_tb___024root__trace_const_0_sub_0(Vtop_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+61,(vlSelfRef.top_tb__DOT__dut__DOT__regDest_val),32);
    bufp->fullIData(oldp+62,(8U),32);
    bufp->fullBit(oldp+63,(1U));
    bufp->fullCData(oldp+64,(0U),8);
...
VL_ATTR_COLD void Vtop_tb___024root__trace_full_0_sub_0(Vtop_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    bufp->fullCData(oldp+1,(vlSelfRef.top_tb__DOT__dut__DOT__control_prom__DOT__control_rom[0]),8);
    bufp->fullCData(oldp+2,(vlSelfRef.top_tb__DOT__dut__DOT__control_prom__DOT__control_rom[1]),8);
    bufp->fullCData(oldp+3,(vlSelfRef.top_tb__DOT__dut__DOT__control_prom__DOT__control_rom[2]),8);
    bufp->fullCData(oldp+4,(vlSelfRef.top_tb__DOT__dut__DOT__control_prom__DOT__control_rom[3]),8);
    bufp->fullCData(oldp+5,(vlSelfRef.top_tb__DOT__dut__DOT__control_prom__DOT__control_rom[4]),8);
    bufp->fullCData(oldp+6,(vlSelfRef.top_tb__DOT__dut__DOT__control_prom__DOT__control_rom[5]),8);
    bufp->fullCData(oldp+7,(vlSelfRef.top_tb__DOT__dut__DOT__control_prom__DOT__control_rom[6]),8);
    bufp->fullCData(oldp+8,(vlSelfRef.top_tb__DOT__dut__DOT__control_prom__DOT__control_rom[7]),8);
    bufp->fullIData(oldp+9,(vlSelfRef.top_tb__DOT__dut__DOT__reg_file__DOT__unnamedblk1__DOT__i),32);
    bufp->fullCData(oldp+10,(vlSelfRef.top_tb__DOT__dut__DOT__PC),8);
    bufp->fullCData(oldp+11,((0xffU & ((IData)(1U) 
                                       + (IData)(vlSelfRef.top_tb__DOT__dut__DOT__PC)))),8);
    bufp->fullCData(oldp+12,((0xffU & ((IData)(1U) 
                                       + ((IData)(vlSelfRef.top_tb__DOT__dut__DOT__PC) 
                                          ...
                                          [vlSelfRef.top_tb__DOT__dut__DOT__PC])))),8);
    bufp->fullIData(oldp+13,(vlSelfRef.top_tb__DOT__dut__DOT__instruction__DOT__instructionSimMem
                             [vlSelfRef.top_tb__DOT__dut__DOT__PC]),32);
    bufp->fullCData(oldp+14,((7U & (vlSelfRef.top_tb__DOT__dut__DOT__instruction__DOT__instructionSimMem
                                    [vlSelfRef.top_tb__DOT__dut__DOT__PC] 
                                    >> 0x13U))),3);
    bufp->fullCData(oldp+15,((7U & vlSelfRef.top_tb__DOT__dut__DOT__instruction__DOT__instructionSimMem
                              [vlSelfRef.top_tb__DOT__dut__DOT__PC])),3);
    bufp->fullSData(oldp+16,((0xffffU & vlSelfRef.top_tb__DOT__dut__DOT__instruction__DOT__instructionSimMem
                              [vlSelfRef.top_tb__DOT__dut__DOT__PC])),16);
    bufp->fullIData(oldp+17,((((- (IData)((1U & (vlSelfRef.top_tb__DOT__dut__DOT__instruction__DOT__instructionSimMem
                                                 [vlSelfRef.top_tb__DOT__dut__DOT__PC] 
                                                 >> 0xfU)))) 
                               << 0x10U) | (0xffffU 
                                            & vlSelfRef.top_tb__DOT__dut__DOT__instruction__DOT__instructionSimMem
                                            [vlSelfRef.top_tb__DOT__dut__DOT__PC]))),32);
    bufp->fullCData(oldp+18,(vlSelfRef.top_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                             [vlSelfRef.top_tb__DOT__dut__DOT__opcode]),8);
    bufp->fullBit(oldp+19,((1U & (vlSelfRef.top_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                                  [vlSelfRef.top_tb__DOT__dut__DOT__opcode] 
                                  >> 7U))));
    bufp->fullCData(oldp+20,((3U & (vlSelfRef.top_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                                    [vlSelfRef.top_tb__DOT__dut__DOT__opcode] 
                                    >> 5U))),2);
    bufp->fullBit(oldp+21,((1U & (vlSelfRef.top_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                                  [vlSelfRef.top_tb__DOT__dut__DOT__opcode] 
                                  >> 3U))));
    bufp->fullBit(oldp+22,((1U & (vlSelfRef.top_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                                  [vlSelfRef.top_tb__DOT__dut__DOT__opcode] 
                                  >> 1U))));
    bufp->fullBit(oldp+23,((1U & vlSelfRef.top_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                            [vlSelfRef.top_tb__DOT__dut__DOT__opcode])));
    bufp->fullIData(oldp+24,(vlSelfRef.top_tb__DOT__dut__DOT__data_memory__DOT__dataSimMem
                             [(0xffU & vlSelfRef.top_tb__DOT__dut__DOT__aluResult)]),32);
    bufp->fullIData(oldp+25,(vlSelfRef.top_tb__DOT__dut__DOT__data_memory__DOT__dataSimMem
                             [0U]),32);
    bufp->fullIData(oldp+26,((((IData)(vlSelfRef.top_tb__DOT__dut__DOT____VdfgExtracted_h91fc6582__0) 
                               ...
                               : ((IData)(vlSelfRef.top_tb__DOT__dut__DOT____VdfgExtracted_h91fc6582__0)
                                  ...
                                  [(0xffU & vlSelfRef.top_tb__DOT__dut__DOT__aluResult)]))),32);
    bufp->fullBit(oldp+27,((1U & ((vlSelfRef.top_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                                   [vlSelfRef.top_tb__DOT__dut__DOT__opcode] 
                                   >> 1U) & vlSelfRef.top_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                                  [vlSelfRef.top_tb__DOT__dut__DOT__opcode]))));
    bufp->fullWData(oldp+28,(vlSelfRef.top_tb__DOT__dut__DOT__reg_file__DOT__registers),256);
    bufp->fullBit(oldp+36,(((IData)(vlSelfRef.top_tb__DOT__dut__DOT____VdfgRegularize_hd1a8765f_1_4) 
    ...
    bufp->fullCData(oldp+37,((0xffU & vlSelfRef.top_tb__DOT__dut__DOT__regA_val)),8);
    bufp->fullBit(oldp+38,(((IData)(vlSelfRef.top_tb__DOT__dut__DOT____VdfgRegularize_hd1a8765f_1_1) 
                            & ((~ (IData)(vlSelfRef.top_tb__DOT__dut__DOT____VdfgRegularize_hd1a8765f_1_2)) 
                               & (IData)(vlSelfRef.top_tb__DOT__dut__DOT__equal)))));
    bufp->fullBit(oldp+39,(((IData)(vlSelfRef.top_tb__DOT__dut__DOT____VdfgRegularize_hd1a8765f_1_1) 
                            & ((~ (IData)(vlSelfRef.top_tb__DOT__dut__DOT__equal)) 
                               & (IData)(vlSelfRef.top_tb__DOT__dut__DOT____VdfgRegularize_hd1a8765f_1_2)))));
    bufp->fullCData(oldp+40,(vlSelfRef.top_tb__DOT__dut__DOT__regB_loc),3);
    bufp->fullCData(oldp+41,(vlSelfRef.top_tb__DOT__dut__DOT__opcode),3);
    bufp->fullBit(oldp+42,(vlSelfRef.top_tb__DOT__dut__DOT__regFileWrEn));
    bufp->fullBit(oldp+43,(vlSelfRef.top_tb__DOT__dut__DOT__aluMode));
    bufp->fullIData(oldp+44,(vlSelfRef.top_tb__DOT__dut__DOT__regA_val),32);
    bufp->fullIData(oldp+45,(vlSelfRef.top_tb__DOT__dut__DOT__regB_val),32);
    bufp->fullIData(oldp+46,(vlSelfRef.top_tb__DOT__dut__DOT__aluResult),32);
    bufp->fullBit(oldp+47,(vlSelfRef.top_tb__DOT__dut__DOT__zeroFlag));
    bufp->fullBit(oldp+48,(vlSelfRef.top_tb__DOT__dut__DOT__equal));
    bufp->fullBit(oldp+49,(vlSelfRef.top_tb__DOT__dut__DOT__overflow));
    bufp->fullCData(oldp+50,(vlSelfRef.top_tb__DOT__dut__DOT__regFileReadMux),3);
    bufp->fullIData(oldp+51,(vlSelfRef.top_tb__DOT__dut__DOT__aluMux),32);
    bufp->fullBit(oldp+52,(vlSelfRef.top_tb__DOT__dut__DOT__alu__DOT__sameMSB));
    bufp->fullCData(oldp+53,((0xffU & vlSelfRef.top_tb__DOT__dut__DOT__aluResult)),8);
    bufp->fullIData(oldp+54,(vlSelfRef.top_tb__DOT__dut__DOT__reg_file__DOT__unnamedblk2__DOT__j),32);
    bufp->fullBit(oldp+55,(vlSelfRef.top_tb__DOT__clk));
    bufp->fullBit(oldp+56,(vlSelfRef.top_tb__DOT__rst));
    bufp->fullBit(oldp+57,((1U & (~ (IData)(vlSelfRef.top_tb__DOT__rst)))));
    bufp->fullCData(oldp+58,(((IData)(vlSelfRef.top_tb__DOT__rst)
                               ? (0xffU & (((IData)(vlSelfRef.top_tb__DOT__dut__DOT____VdfgRegularize_hd1a8765f_1_1) 
                                            & ((~ (IData)(vlSelfRef.top_tb__DOT__dut__DOT____VdfgRegularize_hd1a8765f_1_2)) 
                                               & (IData)(vlSelfRef.top_tb__DOT__dut__DOT__equal)))
                                            ? ((IData)(1U) 
                                               + ((IData)(vlSelfRef.top_tb__DOT__dut__DOT__PC) 
