...
#include "VbubbleSort7Final_tb__Syms.h"


VL_ATTR_COLD void VbubbleSort7Final_tb___024root__trace_init_sub__TOP__0(VbubbleSort7Final_tb___024root* vlSelf, VerilatedVcd* tracep) {
    (void)vlSelf;  // Prevent unused variable warning
    VbubbleSort7Final_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VbubbleSort7Final_tb___024root__trace_init_sub__TOP__0\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
    const int c = vlSymsp->__Vm_baseCode;
    // Body
    tracep->pushPrefix("bubbleSort7Final_tb", VerilatedTracePrefixType::SCOPE_MODULE);
...
VL_ATTR_COLD void VbubbleSort7Final_tb___024root__trace_init_top(VbubbleSort7Final_tb___024root* vlSelf, VerilatedVcd* tracep) {
    (void)vlSelf;  // Prevent unused variable warning
    VbubbleSort7Final_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VbubbleSort7Final_tb___024root__trace_init_top\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VbubbleSort7Final_tb___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void VbubbleSort7Final_tb___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
VL_ATTR_COLD void VbubbleSort7Final_tb___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void VbubbleSort7Final_tb___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void VbubbleSort7Final_tb___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/);

VL_ATTR_COLD void VbubbleSort7Final_tb___024root__trace_register(VbubbleSort7Final_tb___024root* vlSelf, VerilatedVcd* tracep) {
    (void)vlSelf;  // Prevent unused variable warning
    VbubbleSort7Final_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VbubbleSort7Final_tb___024root__trace_register\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&VbubbleSort7Final_tb___024root__trace_const_0, 0U, vlSelf);
    tracep->addFullCb(&VbubbleSort7Final_tb___024root__trace_full_0, 0U, vlSelf);
    tracep->addChgCb(&VbubbleSort7Final_tb___024root__trace_chg_0, 0U, vlSelf);
    tracep->addCleanupCb(&VbubbleSort7Final_tb___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void VbubbleSort7Final_tb___024root__trace_const_0_sub_0(VbubbleSort7Final_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void VbubbleSort7Final_tb___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VbubbleSort7Final_tb___024root__trace_const_0\n"); );
    // Init
    VbubbleSort7Final_tb___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VbubbleSort7Final_tb___024root*>(voidSelf);
    VbubbleSort7Final_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    VbubbleSort7Final_tb___024root__trace_const_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void VbubbleSort7Final_tb___024root__trace_const_0_sub_0(VbubbleSort7Final_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    VbubbleSort7Final_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VbubbleSort7Final_tb___024root__trace_const_0_sub_0\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    bufp->fullIData(oldp+62,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__regDest_val),32);
...
VL_ATTR_COLD void VbubbleSort7Final_tb___024root__trace_full_0_sub_0(VbubbleSort7Final_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void VbubbleSort7Final_tb___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VbubbleSort7Final_tb___024root__trace_full_0\n"); );
    // Init
    VbubbleSort7Final_tb___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VbubbleSort7Final_tb___024root*>(voidSelf);
    VbubbleSort7Final_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    VbubbleSort7Final_tb___024root__trace_full_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void VbubbleSort7Final_tb___024root__trace_full_0_sub_0(VbubbleSort7Final_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    VbubbleSort7Final_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VbubbleSort7Final_tb___024root__trace_full_0_sub_0\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    bufp->fullCData(oldp+1,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom[0]),8);
    bufp->fullCData(oldp+2,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom[1]),8);
    bufp->fullCData(oldp+3,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom[2]),8);
    bufp->fullCData(oldp+4,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom[3]),8);
    bufp->fullCData(oldp+5,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom[4]),8);
    bufp->fullCData(oldp+6,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom[5]),8);
    bufp->fullCData(oldp+7,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom[6]),8);
    bufp->fullCData(oldp+8,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom[7]),8);
    bufp->fullIData(oldp+9,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__reg_file__DOT__unnamedblk1__DOT__i),32);
    bufp->fullCData(oldp+10,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__PC),8);
    bufp->fullCData(oldp+11,((0xffU & ((IData)(1U) 
                                       + (IData)(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__PC)))),8);
    bufp->fullCData(oldp+12,((0xffU & ((IData)(1U) 
                                       + ((IData)(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__PC) 
                                          + vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__instruction__DOT__instructionSimMem
                                          [vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__PC])))),8);
    bufp->fullIData(oldp+13,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__instruction__DOT__instructionSimMem
                             [vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__PC]),32);
    bufp->fullCData(oldp+14,((7U & (vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__instruction__DOT__instructionSimMem
                                    [vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__PC] 
                                    >> 0x13U))),3);
    bufp->fullCData(oldp+15,((7U & vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__instruction__DOT__instructionSimMem
                              [vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__PC])),3);
    bufp->fullSData(oldp+16,((0xffffU & vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__instruction__DOT__instructionSimMem
                              [vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__PC])),16);
    bufp->fullIData(oldp+17,((((- (IData)((1U & (vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__instruction__DOT__instructionSimMem
                                                 [vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__PC] 
                                                 >> 0xfU)))) 
                               << 0x10U) | (0xffffU 
                                            & vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__instruction__DOT__instructionSimMem
                                            [vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__PC]))),32);
    bufp->fullCData(oldp+18,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                             [vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__opcode]),8);
    bufp->fullBit(oldp+19,((1U & (vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                                  [vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__opcode] 
                                  >> 7U))));
    bufp->fullCData(oldp+20,((3U & (vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                                    [vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__opcode] 
                                    >> 5U))),2);
    bufp->fullBit(oldp+21,((1U & (vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                                  [vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__opcode] 
                                  >> 3U))));
    bufp->fullBit(oldp+22,((1U & (vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                                  [vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__opcode] 
                                  >> 1U))));
    bufp->fullBit(oldp+23,((1U & vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                            [vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__opcode])));
    bufp->fullIData(oldp+24,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__data_memory__DOT__dataSimMem
                             [(0xffU & vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__aluResult)]),32);
    bufp->fullIData(oldp+25,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__data_memory__DOT__dataSimMem
                             [0U]),32);
    bufp->fullIData(oldp+26,(((5U == (IData)(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__opcode))
                               ? (0xffU & ((IData)(1U) 
                                           + (IData)(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__PC)))
                               : ((0x20U & vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                                  ...
                                  [(0xffU & vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__aluResult)]))),32);
    bufp->fullBit(oldp+27,((1U & ((vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                                   [vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__opcode] 
                                   >> 1U) & vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__control_prom__DOT__control_rom
                                  [vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__opcode]))));
    bufp->fullWData(oldp+28,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__reg_file__DOT__registers),256);
    bufp->fullBit(oldp+36,(((IData)(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT____VdfgRegularize_hd1a8765f_1_4) 
    ...
    bufp->fullCData(oldp+37,((0xffU & vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__regA_val)),8);
    bufp->fullBit(oldp+38,(((IData)(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT____VdfgRegularize_hd1a8765f_1_1) 
                            & ((~ (IData)(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT____VdfgRegularize_hd1a8765f_1_2)) 
                               & (IData)(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__equal)))));
    bufp->fullBit(oldp+39,(((IData)(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT____VdfgRegularize_hd1a8765f_1_1) 
                            & ((~ (IData)(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__equal)) 
                               & (IData)(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT____VdfgRegularize_hd1a8765f_1_2)))));
    bufp->fullCData(oldp+40,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__regB_loc),3);
    bufp->fullCData(oldp+41,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__opcode),3);
    bufp->fullBit(oldp+42,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__regFileWrEn));
    bufp->fullBit(oldp+43,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__aluMode));
    bufp->fullIData(oldp+44,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__regA_val),32);
    bufp->fullIData(oldp+45,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__regB_val),32);
    bufp->fullIData(oldp+46,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__aluResult),32);
    bufp->fullBit(oldp+47,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__zeroFlag));
    bufp->fullBit(oldp+48,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__equal));
    bufp->fullBit(oldp+49,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__overflow));
    bufp->fullCData(oldp+50,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__regFileReadMux),3);
    bufp->fullIData(oldp+51,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__aluMux),32);
    bufp->fullBit(oldp+52,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__alu__DOT__sameMSB));
    bufp->fullCData(oldp+53,((0xffU & vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__aluResult)),8);
    bufp->fullIData(oldp+54,(vlSelfRef.bubbleSort7Final_tb__DOT__dut__DOT__reg_file__DOT__unnamedblk2__DOT__j),32);
    bufp->fullBit(oldp+55,(vlSelfRef.bubbleSort7Final_tb__DOT__clk));
    bufp->fullBit(oldp+56,(vlSelfRef.bubbleSort7Final_tb__DOT__rst));
    bufp->fullBit(oldp+57,((1U & (~ (IData)(vlSelfRef.bubbleSort7Final_tb__DOT__rst)))));
    bufp->fullCData(oldp+58,(((IData)(vlSelfRef.bubbleSort7Final_tb__DOT__rst)
