...
extern const VlWide<12>/*383:0*/ Vtop_tb__ConstPool__CONST_hd7141760_0;
extern const VlWide<12>/*383:0*/ Vtop_tb__ConstPool__CONST_h231c5920_0;
...
VL_ATTR_COLD void Vtop_tb___024root___eval_initial__TOP(Vtop_tb___024root* vlSelf) {
    ...
    vlSelfRef.top_tb__DOT__dut__DOT__reg_file__DOT__unnamedblk1__DOT__i = 8U;
    VL_READMEM_N(true, 32, 256, 0, VL_CVT_PACK_STR_NW(12, Vtop_tb__ConstPool__CONST_hd7141760_0)
                 ,  &(vlSelfRef.top_tb__DOT__dut__DOT__instruction__DOT__instructionSimMem)
                 , 0, ~0ULL);
    VL_READMEM_N(true, 8, 8, 0, VL_CVT_PACK_STR_NW(12, Vtop_tb__ConstPool__CONST_h231c5920_0)
...
#endif
            VL_FATAL_MT("src/top_tb.sv", 4, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtop_tb___024root___ctor_var_reset(Vtop_tb___024root* vlSelf) {
    ...
    vlSelf->top_tb__DOT__dut__DOT__PC = VL_RAND_RESET_I(8);
    vlSelf->top_tb__DOT__dut__DOT__regB_loc = VL_RAND_RESET_I(3);
    vlSelf->top_tb__DOT__dut__DOT__opcode = VL_RAND_RESET_I(3);
    vlSelf->top_tb__DOT__dut__DOT__regFileWrEn = VL_RAND_RESET_I(1);
    vlSelf->top_tb__DOT__dut__DOT__aluMode = VL_RAND_RESET_I(1);
    vlSelf->top_tb__DOT__dut__DOT__regA_val = VL_RAND_RESET_I(32);
    vlSelf->top_tb__DOT__dut__DOT__regB_val = VL_RAND_RESET_I(32);
    vlSelf->top_tb__DOT__dut__DOT__regDest_val = VL_RAND_RESET_I(32);
    vlSelf->top_tb__DOT__dut__DOT__aluResult = VL_RAND_RESET_I(32);
    vlSelf->top_tb__DOT__dut__DOT__zeroFlag = VL_RAND_RESET_I(1);
    vlSelf->top_tb__DOT__dut__DOT__equal = VL_RAND_RESET_I(1);
    vlSelf->top_tb__DOT__dut__DOT__overflow = VL_RAND_RESET_I(1);
    vlSelf->top_tb__DOT__dut__DOT__regFileReadMux = VL_RAND_RESET_I(3);
    vlSelf->top_tb__DOT__dut__DOT__aluMux = VL_RAND_RESET_I(32);
    vlSelf->top_tb__DOT__dut__DOT____VdfgExtracted_h91fc6582__0 = VL_RAND_RESET_I(1);
    vlSelf->top_tb__DOT__dut__DOT____VdfgRegularize_hd1a8765f_1_1 = VL_RAND_RESET_I(1);
    vlSelf->top_tb__DOT__dut__DOT____VdfgRegularize_hd1a8765f_1_2 = VL_RAND_RESET_I(1);
    vlSelf->top_tb__DOT__dut__DOT____VdfgRegularize_hd1a8765f_1_3 = VL_RAND_RESET_I(1);
    vlSelf->top_tb__DOT__dut__DOT____VdfgRegularize_hd1a8765f_1_4 = VL_RAND_RESET_I(1);
    vlSelf->top_tb__DOT__dut__DOT__PC_File__DOT__newPC = VL_RAND_RESET_I(8);
    VL_RAND_RESET_W(256, vlSelf->top_tb__DOT__dut__DOT__reg_file__DOT__registers);
    vlSelf->top_tb__DOT__dut__DOT__reg_file__DOT__unnamedblk1__DOT__i = 0;
    vlSelf->top_tb__DOT__dut__DOT__reg_file__DOT__unnamedblk2__DOT__j = 0;
    vlSelf->top_tb__DOT__dut__DOT__alu__DOT__sameMSB = VL_RAND_RESET_I(1);
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
        vlSelf->top_tb__DOT__dut__DOT__instruction__DOT__instructionSimMem[__Vi0] = VL_RAND_RESET_I(32);
    }
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->top_tb__DOT__dut__DOT__control_prom__DOT__control_rom[__Vi0] = VL_RAND_RESET_I(8);
    }
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
        vlSelf->top_tb__DOT__dut__DOT__data_memory__DOT__dataSimMem[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->__VdlyVal__top_tb__DOT__clk__v0 = VL_RAND_RESET_I(1);
    vlSelf->__VdlySet__top_tb__DOT__clk__v0 = 0;
