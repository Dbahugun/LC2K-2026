...
inner	beq	1	6	idone	ptr == &arr[5] -> pass complete
...
fini	lw	0	2	arr	r2 = smallest (display checkpoint)
	...
	halt
count	.fill	5	N-1 passes for N = 6
negone	.fill	-1
one	.fill	1
...
arr	.fill	89
	.fill	12	unlabeled .fill line
	.fill	-5	negative element: tests signed compare
	.fill	305
	.fill	12	duplicate: tests equal-elements path
last	.fill	7
